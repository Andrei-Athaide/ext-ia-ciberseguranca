...
Em alguma sala de aula reservada da UNICAMP.

### Recursos Necessários

Materiais para uso nas dinâmicas: Sulfites, lápis e canetinhas, slides com as situações e com conceitos e/ou mensagens que queremos transmitir.

Algumas cópias dos materiais desenvolvidos pela Cert, tal quais: 
- “Golpes: Evite Fraudes”
- “Golpes: Caiu? Veja o que Fazer”
- “Golpes: Não se Deixe Enganar”

Internet da Unicamp, Notebook e projetores, para apresentação dos slides. 

### Desenvolvimento Prévio

Antes da realização da oficina, serão desenvolvidos os slides utilizados na apresentação, os roteiros das dinâmicas e os exemplos de situações de golpes que serão apresentados aos participantes. Também será necessário preparar e testar previamente os áudios gerados por IA, garantindo que os recursos utilizados nas demonstrações estejam funcionando adequadamente.

### Desafios

Alguns desafios previstos são:
- Garantir acessibilidade e linguagem adequada ao público.
- Garantir a qualidade e a reprodução dos áudios, considerando que a ferramenta utilizada é paga.
- Garantir o funcionamento da ferramenta durante a realização da oficina.
- Evitar constrangimento ou medo durante as demonstrações.

## Resultados Esperados

- Conscientização acerca dos perigos e riscos que a IA pode trazer para o ambiente virtual, especialmente na criação e aplicação de golpes e fraudes; 
- Desenvolvimento de um senso crítico e mais cuidadoso diante de mensagens, fotos, áudios e conteúdos recebidos pela internet.
- Incentivo à disseminação do aprendizado para amigos e familiares. 

Temos como objetivo realizar uma comparação nas respostas dos participantes, mediante a algumas situações e casos, antes e depois de abordarmos o tema. De modo que seja possível comparar as respostas e aferir que os participantes entenderam o que queríamos transmitir e se conseguem aplicar isso no seu dia a dia.

Indicadores de sucesso poderiam ser:
- Participação e interesse dos participantes durante o desenvolvimento da oficina.
- Número de participantes que conseguem identificar corretamente situações suspeitas antes e depois da atividade.
- Número de participantes que passam a escolher confirmar por outro canal antes de realizar uma ação.
- Número de participantes que conseguem explicar pelo menos uma estratégia segura de verificação.
- Mudança nas respostas entre a primeira e a segunda rodada de situações.
- Feedback positivo dos participantes com possiveis relatos pessoais
