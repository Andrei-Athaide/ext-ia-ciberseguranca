# `Ciberidosos: Como evitar golpes digitais`
...
A atividade apresenta viabilidade para ser executada, mas necessita de alguns recursos, como computador, projetor ou televisão, slides, vídeos e materiais impressos. A oficina poderá ser realizada presencialmente em casas de repouso ou outros espaços de fácil acesso ao público 60+, como bibliotecas públicas ou espaços da universidade.

Para tal, a equipe deverá desenvolver os materiais da apresentação, preparar o quiz e selecionar exemplos de golpes digitais relevantes ao cotidiano dos participantes. Também será necessário estabelecer contato prévio com os locais onde as oficinas podem ser realizadas e adequar a duração, se preciso.

A proposta prevê uma apresentação introdutória divida em partes, seguida de uma atividade prática em grupos, permitindo avaliar a compreensão dos participantes por meio de um quiz aplicado durante a atividade.
...
Serão necessários computador, projetor ou televisão, acesso à internet, slides, vídeos, materiais impressos, papel, lápis, borracha e caneta.
